...
BAZEL_BUILD_OPTIONS="-c dbg --config=msvc-cl --show_task_finish --verbose_failures \
...
bazel ${BAZEL_STARTUP_OPTIONS} test ${BAZEL_BUILD_OPTIONS} //test/common/network:connection_impl_test
