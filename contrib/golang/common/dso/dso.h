...
public:
  ...
  virtual void envoyGoCallback(GoFunction hand, void* data, GoInt sz) PURE;
};
...
public:
  ...
  void envoyGoCallback(GoFunction hand, void* data, GoInt sz) override;
...
private:
  ...
  void (*envoy_go_filter_go_callback_)(GoFunction hand, void* data, GoInt sz) = {nullptr};
};
