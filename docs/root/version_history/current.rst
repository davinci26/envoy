...
* original_dst*: added support for :ref:`Original Destination <config_listener_filters_original_dst_filter>` on Windows. With this change Envoy can be used as sidecar proxy on Windows.
